...
///
/// ```rust
/// use border_generic_replay_buffer::{GenericReplayBufferConfig, PerConfig};
///
/// // Basic configuration
/// let config = GenericReplayBufferConfig::default()
///     .capacity(10000)
///     .seed(42);
///
/// // Configuration with PER
/// let config_with_per = GenericReplayBufferConfig::default()
///     .capacity(10000)
///     .seed(42)
///     .per_config(Some(PerConfig::default()));
/// ```
#[derive(Debug, Deserialize, Serialize, PartialEq, Clone)]
pub struct GenericReplayBufferConfig {
...
impl Default for GenericReplayBufferConfig {
...
impl GenericReplayBufferConfig {
